...
export default class Vizualization {
  ...
  preload() {
    this.knightSprite.src = './assets/sprites/knight.png';
    this.monsterSprite.src = './assets/sprites/monsters.png';
    this.fireBallSprite.src = './assets/sprites/fire.png';
    this.healSprite.src = './assets/sprites/heal.png';
    this.fireAttackSprite.src = './assets/sprites/fire_attacks.png';
  }
