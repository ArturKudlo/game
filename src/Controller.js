...
export default class Controller {
  constructor() {
    ...
    this.spell0 = new Audio('assets/sounds/spell_one.mp3');
    this.spell1 = new Audio('assets/sounds/spell_two.wav');
    this.monsterSpell0 = new Audio('assets/sounds/monsters.wav');
  }
